0，安装开发环境：pip install -i https://pypi.douban.com/simple/ --trusted-host=pypi.douban.com/simple -r requirements.txt
1, 安装cuda版本的：pip install torch==1.7.0+cu101 torchvision==0.8.1+cu101 torchaudio==0.7.0 -f https://download.pytorch.org/whl/torch_stable.html

2，检测行人图片集：
python detect.py --weights yolov5s.pt --img 640 --conf 0.25 --source data/images

3，检测行人视频：
python detect.py --weights yolov5s.pt --img 640 --conf 0.25 --source people.mp4

4，训练权重：python train.py --img 640 --batch 4 --epochs 120 --data ./data/custom_data.yaml --cfg ./models/custom_yolov5.yaml --weights ./weights/yolov5l.pt
